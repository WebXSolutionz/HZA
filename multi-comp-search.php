...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
      <a class="navbar-brand me-lg-5" href="single-comp-search.php"> <img class="navbar-brand-dark" src="assets/img/logo/LOGO.png" alt="logo" /> <img class="navbar-brand-light" src="assets/img/brand/dark.svg" alt="logo" /> </a>
          ...
          <div class="row">
            <div class="col-12 mb-4">
              <form>
                ...
                <button type="submit" class="btn btn-gray-800 px-4">Search</button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
              <div class="card border-0 shadow mb-4">
                <div class="table-responsive w-100">
                  <table class="table table-centered w-100 table-nowrap mb-0 rounded">
                    <thead>
                      <tr>
                        <th class="border-0 rounded-start">Sr #</th>
                        <th class="border-0">SIC Code</th>
                        <th class="border-0">Company Name</th>
                        <th class="border-0">Company Number</th>
                        <th class="border-0">Registered Address</th>
                        <th class="border-0">Charges</th>
                        <th class="border-0">Date Creation</th>
                        <th class="border-0">Status</th>
                        <th class="border-0">Persons Entitled</th>
                        <th class="border-0">Brief Description</th>
                        <th class="border-0">Charge code</th>
                        <th class="border-0 rounded-end">Company Link</th>
                      </tr>
                    </thead>
                    <tbody>
                      <!-- Item -->
            ...
            <div class="row gap-2 d-flex justify-content-between">
              <div class="col-md-6 d-flex gap-1">
                <button type="submit" class="btn btn-gray-800 px-4 text-nowrap">Pause</button>
                <button type="submit" class="btn btn-gray-800 px-4 text-nowrap">Resume</button>
                <button type="submit" class="btn btn-gray-800 px-4 text-nowrap">Stop</button>
              </div>
